...
scripts/
  ...
  quantum_ansatz.py       Shared circuit + failure-mask definitions (imported
  ...
  run_benchmarks.py        Porter-Thomas / clipping-sweep / squeezing figures
...
notebooks/analysis.ipynb  Exploratory analysis and comparison plots
